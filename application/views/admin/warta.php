                        ...
                        <div class="row">
                            <div class="col offset-xl-0">
                                <div class="card shadow mb-3">
                                    ...
                                    <?php endif;?>
                                     <form action="<?= base_url()?>admin/uploadwarta" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><label for="username"><strong>Nama File</strong></label><input class="form-control" type="text" placeholder="nama File warta" name="nama_file"></div>
                                                </div>
                                            </div>

                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group"><input type="file" name="warta"></div>
                                                </div>
                                            </div>
                                            <div class="form-group"><button class="btn btn-primary btn-sm" type="submit" name="submit">Publish</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
